...
class CSVIngestion:
    ...
    def __init__(self, db_name, db_user, db_host, db_password, data_path) -> None:
    ...
    def transform_data(self, df):
        ...
        # Check if the column is of object type (typically string in pandas)
            ...
            # Convert comma sepearated values to float
                # df[column] = df[column].apply(self.convert_to_float)
